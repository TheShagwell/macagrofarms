                    ...
                    <div class="col-md-12 col-lg-12 col-xl-5">
                        <div class="team-one__content">
                            <div class="block-title">
                                ...
                                <!-- /.block-title__image -->
                                <p>meet the team</p>
                                <h3>Our Self-Motivated <br> Crew</h3>
                            </div>
                            <!-- /.block-title -->
                            <div class="team-one__summery">
                                <p>We are on verge to better the lives of Nigerians, Africa by creating sustainable solutions towards poverty and hunger stike through agriculture by improving the agri-tech ecosystem</p>
                            </div>
                            <!-- /.team-one__summery -->
                    ...
                    <div class="col-lg-6">
                        <div class="about-three__content">
                            <div class="block-title">
                                ...
                                <!-- /.block-title__image -->
                                <p>Get to know us</p>
                                <h3>18 Years Agriculture Experience
                                </h3>
                            </div>
                            <!-- /.block-title -->
                            <ul class="about-three__list list-unstyled">
                                <li>
                                    <i class="fa fa-check-circle"></i> Recognized for Greatness
                                </li>
                                <li>
                                    <i class="fa fa-check-circle"></i> Secured Investments
                                </li>
                                <li>
                                    <i class="fa fa-check-circle"></i> Best Agri-Tech Online Shop
                                </li>
                                <li>
                                    <i class="fa fa-check-circle"></i> Premium Services
                                </li>
                            </ul>
                            <!-- /.about-three__list list-unstyled -->
                            <div class="about-three__summery">
                                <p> We understand the AgricTech space perfectly thats why we are in mission and vision of ensuring adequate food security in Nigeria and Africa.</p>
                            </div>
