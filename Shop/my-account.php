...
<?php
    ...
    $user_details = getWhere('users', 'id', $_SESSION['user']);
                            ...
                            <div class="tab-content" id="myaccountContent">
                                ...
                                <div class="tab-pane fade show active" id="dashboad" role="tabpanel">
                                    <div class="myaccount-content">
                                        <h3>Dashboard</h3>
                                        <div class="welcome">
                                            <p>Hello, <strong><?= $firstname . " " . $lastname; ?></strong> (If Not <strong><?= $lastname; ?> !</strong><a
                                    ...
                                    <div class="myaccount-content">
                                        ...
                                        <div class="myaccount-table table-responsive text-center">
                                            <table class="table table-bordered">
                                                ...
                                                <?php
                                            $carts = getPlaced("cart", "user_id", $_SESSION['user']);
                                            if (!empty($carts)) {
                                                foreach ($carts as $cart) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?= ($delivered == 0) ? "On transit":  "Delivered";  ?></td>
