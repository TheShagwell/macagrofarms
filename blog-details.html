                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="blog-details__content">
                            <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some injected or words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum,
                                ...
                                Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. </p>
                            <p>
                        ...
                        <div class="blog-comment">
                            ...
                            <div class="blog-comment__box">
                                ...
                                <div class="blog-comment__content">
                                    <h3>Jessica Brown</h3>
                                    <p>It has survived not only five centuries, but also the leap into electronic typesetting unchanged. It was popularised in the sheets If you are going to use a passage of Lorem Ipsum, you need to be is simply free text.</p>
                            ...
                            <ul class="list-unstyled footer-widget__post">
                                <li>
                                    ...
                                    <div class="footer-widget__post-content">
                                        ...
                                        <h4><a href="blog-details.html">How to grow beehives in the farms</a></h4>
                                    </div>
                                ...
                                <li>
                                    ...
                                    <div class="footer-widget__post-content">
                                        ...
                                        <h4><a href="blog-details.html">Organic Palm Kernel Oil and its important</a></h4>
                                    </div>
                                    <!-- /.footer-widget__post-content -->
                                </li>
                            </ul>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
                        ...
                        <ul class="list-unstyled footer-widget__contact">
                            ...
                            <li>
                                ...
                                <a href="mailto:info@macagrofarms.com">info@macagrofarms.com</a>
                            </li>
                            <li>
                                <i class="agrikon-icon-pin"></i>
                                <a href="#">Delta State, Nigeria</a>
                            </li>
                        </ul>
                        <!-- /.list-unstyled -->
                    </div>
