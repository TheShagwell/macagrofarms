...
<head>
    ...
    <title>Macagrofarms Store | Recove Password Admin Dashboard</title>
    <link rel="icon" type="image/x-icon" href="assets/img/macagroFavicon.png" />
    <!-- BEGIN GLOBAL MANDATORY STYLES -->
    <link href='https://fonts.googleapis.com/css?family=Open+Sans:400,600,700' rel='stylesheet' type='text/css'>
    <link href="bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="assets/css/plugins.css" rel="stylesheet" type="text/css" />
    <link href="assets/css/users/pass_recovery_2.css" rel="stylesheet" type="text/css" />
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="login-text text-center">
                    <p class="mt-3 text-white">Not you? <a href="login.html" class="">Sign in </a> as different user!</p>
                </div>
            </div>
        </div>
    </form>
